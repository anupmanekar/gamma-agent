...
class BrowserNodeAdapter:
    ...
    async def execute_browser_actions(self, state: VanillaGraphState) -> None:
        ...
        try:
            ...
            logger.error(f"Error in execute_browser_actions")
            state.action_results.append(f"Error executing browser actions: {e}")
    ...
    async def _command_receiver(self, command: str, **kwargs):
        ...
        try:
            logger.info(f"Executing command: {command} with arguments: {kwargs}")
    ...
    async def _open_browser(self, url: str, **kwargs) -> None:
        try:
            ...
            logger.error(f"Error in _open_browser: {e}")
            raise e
    ...
    async def _search_in_browser(self, query: str, **kwargs) -> None:
        try:
            ...
            logger.error(f"Error in _search_in_browser: {e}")
            raise e
    ...
    async def _click_search_button(self, **kwargs) -> None:
        try:
            ...
            logger.error(f"Error in _click_search_button: {e}")
            raise e
